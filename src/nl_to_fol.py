...
def setup_dataset(fallacy_set='logic',length=100):
    ...
    if fallacy_set == 'folio':
        ...
        df_fallacies=pd.read_csv('data/data1.csv')
...
if __name__ == '__main__':
    ...
    nli_tokenizer = AutoTokenizer.from_pretrained(args.nli_model_name, use_auth_token=token)
    nli_model = AutoModelForSequenceClassification.from_pretrained(args.nli_model_name, use_auth_token=token)
